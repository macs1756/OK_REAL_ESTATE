...
const CONSULTATION_BUTTON = document.querySelectorAll('.consultation');
const MODAL_WRAPPER = document.querySelector('.consultation__wr');
const MODAL_BODY = document.querySelector('.consultation__body');
